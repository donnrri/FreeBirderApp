package fb.components.renders
{
	...
	public class ObservatoryListItemRenderer extends LabelItemRenderer
	{
		...
		private static const ICON_SOURCE:String =  "assets/dpi160/icons/camera_small.png";
		...
		public function ObservatoryListItemRenderer()
		{
			super();
		}
		...
		override public function set data(value:Object):void
		{
			...
			var oo:ObservatoryVO = value as ObservatoryVO;
		    title.htmlLabelText = GO_TO + "<p>" + oo.title + "</p>"; 
			description.htmlText = "<p>" + oo.description + "</p>";  
			satallite.htmlText = "<p>" + oo.satellite + "</p>";  
												   ...
												   unscaledHeight:Number):void
		{
			...
			title.x = 5;
			title.y = 5;
			//title.width = unscaledWidth;  trace(unscaledWidth + " in obs ");
			...
			//satallite.width = unscaledWidth;
			
			link.x = 5;
			link.y = (LABEL_HEIGHT * 3) + 10;
			//link.width = unscaledWidth;
