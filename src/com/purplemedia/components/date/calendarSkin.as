...
package com.purplemedia.components.date
{
	...
	import com.purplemedia.components.date.UIProperties;
	 ...
	 */
	public class calendarSkin extends UIProperties {
		 ...
		 * 
		 */
		public function set WeekStart(s:String):void { _startDay = s; }
		...
		protected function _construct():void {
			...
			Calendar = new SpriteVisualElement();
			isHitted = new Object();
			Calendar.alpha 	= 0;
		...
		/*colorMatrix.createGradientBox(bgWidth,bgHeight,0,0,0);
			...
			bg.graphics.beginFill(0x003f48);  
		 ...
		 */
				...
				currentDateLabel.blendMode      =	BlendMode.LAYER;
				currentDateLabel.selectable 	=	false;
				currentDateLabel.width			=	132;//66;
				currentDateLabel.y				=	12; //6;				
